...
def format_post(html):
    ...
    for tag in post_obj.tags:
        header_html += '<a class="btn btn-default btn-xs tag-link"'
        header_html += 'href="http://mattcarter.co/blog/tag/%s">' % tag
        header_html += '<span class="glyphicon glyphicon-tag"></span> %s</a>' % tag
    header_html += '</p>'
